...
| 채예은 | Front-end           | - 지역 커뮤니티, 아파트 커뮤니티 개발<br/>&nbsp;&nbsp;&nbsp;&nbsp;- 지역 커뮤니티, 아파트 전체 소통, 아파트 익명 소통 구분<br/>&nbsp;&nbsp;&nbsp;&nbsp;- 'react-query'를 이용한 무한스크롤, 카테고리 필터링, 키워드 검색<br/>&nbsp;&nbsp;&nbsp;&nbsp;- 글 작성/조회/수정/삭제 기능<br/>&nbsp;&nbsp;&nbsp;&nbsp;- 댓글 작성/삭제, 비밀댓글 기능<br/>- 'Recoil'을 이용한 상태 관리<br/>- 'Emotion'을 이용한 CSS-in-JS 방식으로 스타일링 구현<br/>- 'Mock Service Worker'를 이용해 목업 API 구현하여 API 테스트 진행 |
