    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                    ...
                    .antMatchers("/api/v1/family-list/*").hasRole("USER")
                    .antMatchers("/api/v1/users/*").hasRole("USER")
                    .antMatchers("/api/v1/board/*").hasRole("USER")
                    .antMatchers("/api/v1/community/*").hasRole("USER")
                    .antMatchers("/api/v1/family-list/*").hasRole("USER")
                    .antMatchers("/api/v1/auth/users/sign-up").hasRole("USER")
                    .antMatchers("/api/v1/auth/users/user-info").hasRole("USER")
                    .antMatchers("/api/v1/auth/users/log-out").hasRole("USER")
                    .antMatchers("/api/v1/auth/users/category-list").hasRole("USER")
